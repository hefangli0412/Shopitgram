...
#import "SIGFollowingTVController.h"
#import "SIGPhotoController.h"

@interface SIGFollowingTVController ()
@property (nonatomic) NSArray *dataSource;
@end

@implementation SIGFollowingTVController
...
- (void)refresh
{
    ...
    NSString *urlString = [[NSString alloc] initWithFormat:@"https://api.instagram.com/v1/users/%@/follows?access_token=%@", userId, accessToken]; // Get the list of users this user follows.
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"followingCell" forIndexPath:indexPath];
